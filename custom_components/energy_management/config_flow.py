...
DATA_SCHEMA = vol.Schema({
    vol.Required("area", default = "cez", description = {SUGGESTED_VALUE: "cez"}): selector.SelectSelector(selector.SelectSelectorConfig(options = ["disabled", "cez", "egd", "pre"], mode = "dropdown", translation_key = "area")),
